...
public class ProfesorController {
	...
	public void inserta() {
		...
		menuService.log(String.format("Añadido profesor %s con nombre %s ", profesor.getId(), profesor.getNombre()),
				false);
	}
	...
	public void valida() {
		...
		if (profesorDAO.existe(nombreUsuario, pass)) {
			...
			Historial h = new Historial(null, "P", this.profesor.getId(), new Date().toInstant().toString());
